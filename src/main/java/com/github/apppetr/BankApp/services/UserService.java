...
import com.github.apppetr.BankApp.DTO.*;
...
import com.github.apppetr.BankApp.repositories.PhoneRepository;
import com.github.apppetr.BankApp.repositories.ProfileRepository;
...
//        user.setPassword(password);
    ...
    public UserBase updatePassword(UserPasswordDTO user) {
        return update(user, (userOld) -> {
            var password = user.getPassword();
            userOld.setPassword(passwordEncoder().encode(password));
        });
    }
